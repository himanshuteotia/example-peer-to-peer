...
async function main() {
  console.log("🚀 Starting Multisig Ticket Triage Demo\n");
  ...
  try {
    // ========================================
    // 1. Start the triage server in-process
    // ========================================
    console.log("📡 Starting Triage Server...");
    server = new TriageServer({
      port: 40001,
      bootstrapPort: 30001,
      dbPath: join(__dirname, "../db/demo-server"),
    });
    ...
    client = new TriageClient({
      port: 50001,
      bootstrapPort: 30001,
      dbPath: join(__dirname, "../db/demo-client"),
    ...
    // Wait longer for DHT to stabilize and find the server
    ...
    // ========================================
    // 4. Submit sample tickets and log results
    // ========================================
    ...
    // ========================================
    // 5. Fetch one ticket by ID and log result
    // ========================================
    ...
    // ========================================
    // 6. Run basic search and log results
    // ========================================
    ...
    // ========================================
    // 7. Test scheduler (wait a bit and check for updates)
    // ========================================
    console.log("⏰ Testing scheduler (waiting 5 seconds for re-triaging)...");
    await new Promise((resolve) => setTimeout(resolve, 5000));
